...
| 건강 기반 길드 | 완료 | `lib/guild_screen.dart` | 영웅·제작·이벤트 방 |
...
| 던전 가중치·안전 규칙 | MVP 완료 | `backend/game_balance_engine.py`, `backend/adventure_service.py`, `lib/guild_screen.dart` | 전투 결과 다양화 |
